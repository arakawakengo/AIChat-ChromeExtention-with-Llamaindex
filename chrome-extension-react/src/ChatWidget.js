...
const ChatWidget = () => {
    ...
    return (
        <div style={{ position: 'fixed', bottom: '10px', right: '10px'}}>
            <button onClick={() => setIsOpen(!isOpen)} style={{ backgroundColor: '#4CAF50', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '12px', cursor: 'pointer', marginBottom: '10px' }}>Toggle Chat</button>
            {isOpen && (
                <div style={{ border: '1px solid black', padding: '10px', width: "30vw", height: "70vh" }}>
                    <ChatContainer>
                        <ConversationHeader>
